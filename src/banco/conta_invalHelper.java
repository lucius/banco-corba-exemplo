...
/**
 * banco/conta_invalHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class conta_invalHelper {
	...
	if (__typeCode == null) {
		...
		if (__typeCode == null) {
		    ...
		    _tcOf_members0 = org.omg.CORBA.ORB.init().create_alias_tc(banco.contaHelper.id(), "conta",
			    _tcOf_members0);
		    _members0[0] = new org.omg.CORBA.StructMember("c", _tcOf_members0, null);
		    __typeCode = org.omg.CORBA.ORB.init().create_exception_tc(banco.conta_invalHelper.id(),
			    "conta_inval", _members0);
		    __active = false;
		}
	    }
	}
