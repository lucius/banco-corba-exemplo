...
/**
 * banco/auto_atendimentoHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class auto_atendimentoHelper {
	...
	if (__typeCode == null) {
	    __typeCode = org.omg.CORBA.ORB.init().create_interface_tc(banco.auto_atendimentoHelper.id(),
		    "auto_atendimento");
	}
	return __typeCode;
    }
